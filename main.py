...
st.markdown("<h2 style='text-align: center;'>✨ PDF IntelliBot ✨</h2>", unsafe_allow_html=True)
...
if query:
    ...
    if small_talk:
        st.session_state.chat.append(("bot", small_talk))
    elif pdf_files:
        ...
        st.session_state.chat.append(("bot", "📄 Please upload a PDF to ask document-based questions."))
